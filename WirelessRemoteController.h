...
class WirelessRemoteController
{
  public:
     ...
     */
    WirelessRemoteController(bool transmitter,uint8 pin_D0, uint8 pin_D1, uint8 pin_D2, uint8 pin_D3);
   ...
   void sendCurrentValue(uint8 datam);
     ...
     */
    void addTrigger(uint8 pin_DT, void (*function)());
